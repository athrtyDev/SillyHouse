...
import 'package:sillyhouseorg/widgets/activity_type_widget.dart';
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(activity!.name!,
                      style: GoogleFonts.kurale(fontSize: 12, color: Styles.textColor70, fontWeight: FontWeight.w500)),
                ),
                Padding(
                  padding: EdgeInsets.fromLTRB(0, 0, 10, 3),
                  child: activity!.difficulty == 'easy'
                      ? Image.asset('lib/assets/icon_easy.png', height: 20)
                      : (activity!.difficulty == 'medium'
                          ? Image.asset('lib/assets/icon_medium.png', height: 20)
                          : (activity!.difficulty == 'hard' ? Image.asset('lib/assets/icon_hard.png', height: 20) : Text(''))),
                )
              ],
            ),
          ],
