              ...
              : Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Silly House',
                          style: GoogleFonts.kurale(fontSize: 30, color: Color(0xff36c1c8), fontWeight: FontWeight.bold)),
                      ...
                      RichText(
                        text: new TextSpan(
                          ...
                          children: <TextSpan>[
                            ...
                            new TextSpan(
                                text: 'Шинэчлэх ', style: new TextStyle(fontWeight: FontWeight.bold, color: Color(0xff36c1c8))),
                            new TextSpan(text: 'товчийг дарж, дараа нь '),
                            new TextSpan(
                                text: 'Update ', style: new TextStyle(fontWeight: FontWeight.bold, color: Color(0xff36c1c8))),
